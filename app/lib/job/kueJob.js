...
class  kueJob{
        ...
        redis: {
          createClientFactory: function () {
             if(!opt.redis_sentinels){
               return opt.redisclient ||  new Redis( { port: opt.redis_port ||7379,          // Redis port
  ...
  // reactiveJobs () {
  //   this.jobs.inactive( function( err, ids ) { // others are active, complete, failed, delayed
