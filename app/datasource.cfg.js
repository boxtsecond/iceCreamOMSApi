...
//       db: 1
//     });
//     var redisShopProductSalve=new Redis({ port: config.redis.salve.port,          // Redis port
//       host: config.redis.salve.host,   // Redis host
//       family: 4,           // 4 (IPv4) or 6 (IPv6)
//       password: config.redis.salve.password,
//       db: 1
...
//       db: 2
//     });
//     var redisWalletModelSalve=new Redis({ port: config.redis.salve.port,          // Redis port
//       host: config.redis.salve.host,   // Redis host
//       family: 4,           // 4 (IPv4) or 6 (IPv6)
//       password: config.redis.salve.password,
//       db: 2
...
//       db: 3
//     });
//     var redisOrdersModelSalve=new Redis({ port: config.redis.salve.port,          // Redis port
//       host: config.redis.salve.host,   // Redis host
//       family: 4,           // 4 (IPv4) or 6 (IPv6)
//       password: config.redis.salve.password,
//       db: 3
