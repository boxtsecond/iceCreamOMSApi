...
// 更新发货
function UpdateOrderDeliver(order) {
  this.updateParams = {};
  this.findCondition = {};
  this.findCondition.sid = order.sid || 1;
  this.findCondition.order_no = order.order_no;
  this.updateParams.is_receipt = 1;
  this.updateParams.order_status = 3;
  this.updateParams.express_company = order.express_company;
  this.updateParams.express_no = order.express_no;
  this.updateParams.ship_completed_time = order.ship_completed_time || eutil.getTimeSeconds();
  this.updateParams.mtime = order.mtime || eutil.getTimeSeconds();
}
