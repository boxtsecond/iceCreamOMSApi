...
function goods (params) {
  ...
  this.import_digital_card_total = params.import_digital_card_total || 0;
}
function goodsResFilter (params, score) {
  ...
  this.channel_h_data= params.channel_h_data || '-1';
  ...
  // this.import_digital_card_total = params.import_digital_card_total;
}
